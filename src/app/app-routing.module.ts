...
const routes: Routes = [
  ...
  {
    path: 'episode-list',
    loadChildren: () => import('./components/pages/episodes/episode-list/episode-list.module').then(m => m.EpisodeListModule)
  },
  {
    path: 'episode-details/:id',
    loadChildren: () => import('./components/pages/episodes/episode-details/episode-details.module').then(m => m.EpisodeDetailsModule)
  }
];
